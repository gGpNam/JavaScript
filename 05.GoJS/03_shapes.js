        ...
        initNodeTemplate: function() {
            ...
            this.diagram.add(
                this.$go(go.Part, "Horizontal",
                         ...
                         this.$go(go.Shape,
                                 { figure: "Club", width: 40, height:40, margin:4, fill: "green" }),
                         this.$go(go.Shape,
                                 { figure: "Club", width: 40, height:40, margin:4, fill: "green", stroke: null }),
                         this.$go(go.Shape,
                                 { figure: "Club", width: 40, height:40, margin:4, fill: null, stroke: "green", strokeWidth: 3 })
                )
            )
        },
