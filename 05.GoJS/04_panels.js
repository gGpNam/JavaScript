$(function() {
    var DocumentView =  Backbone.View.extend({
        ...
        initNodeTemplate: function() {
            this.diagram.add(
                this.$go(go.Part, go.Panel.Position, 
                         { background: "lightgray"},
                         this.$go(go.TextBlock, "default, at (0,0)",
                                  { background: "lightgreen" }),
                         this.$go(go.TextBlock, "(100, 0)",
                                  { position: new go.Point(100, 0), background: "lightgreen" }),
                         this.$go(go.TextBlock, "(0, 100)",
                                  { position: new go.Point(0, 100), background: "lightgreen" }),
                         this.$go(go.TextBlock, "(55, 28)",
                                  { position: new go.Point(55, 28), background: "lightgreen" }),
                         this.$go(go.TextBlock, "(33, 70)",
                                  { position: new go.Point(33, 70), background: "lightgreen" }),
                         this.$go(go.TextBlock, "(100, 100)",
                                  { position: new go.Point(100, 100), background: "lightgreen" })
                )
            );
        },
